...
export function Navbar(props) {
    ...
    const firstIcons = [<DashboardIcon className ={classes.icons}/>, 
    ...
    return (
        <div className={classes.root}>
            ...
            >
                ...
                <Divider />
                <List>
                    {['Dashboard', 'Patients', 'analytics'].map((text, index) => (
                ...
                <List>
                    ...
                    <ListItem button key={text}>
                        <ListItemIcon>{secIcons[index]}</ListItemIcon>
                        <ListItemText primary={text} />
                    </ListItem>
                    ))}
                </List>
